...
const frutas = ["Banana", "Maça", "Morango", "Uva"];
...
// loop
// for
// Ele é composto por 3 partes: inicialização, condição e incremento.
// Exemplo:
...
// map
// O metodo map() invoca a função callback passada por argumento para cada elemento do Array e devolver um novo Array como resultado.
const array1 = [1, 4, 9 ,16];
const map1 = arrayLinks.map((x) => x = 2);
...
// reduce
// O método reduce() executa uma função reducer (forncecida por você) para cada membro do array, resultando num único valor de retorno.
